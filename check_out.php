...
if (isset($_POST['btn_place_order'])) {
    ...
    // Retrieve data from the form and clean it up
    ...
    if (!empty($cart)) {
        ...
        if (mysqli_query($link, $sql_order)) {
            ...
            // --- CREATE ORDER DETAIL (không có payment và customer_id) ---
            $success = true;
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="payment" class="form-select" required>
                        <?php
                        $pm_query = mysqli_query($link, "SELECT payment_id, name FROM payment ORDER BY name");
