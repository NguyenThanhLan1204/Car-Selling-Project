...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <span class="ms-1 font-weight-bold text-white">Car-selling DASHBOAR</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page== "customer.php"? 'active bg-gradient-primary':'' ?>" href="customer.php">
            ...
            <span class="nav-link-text ms-1">Customer manage</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page== "verhical.php"? 'active bg-gradient-primary':'' ?>" href="verhicall.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Verhical manage</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page== "manufacturer.php"? 'active bg-gradient-primary':'' ?>" href="manufacturer.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Manufacturers manage</span>
          </a>
        </li>
        <!--  -->
      </ul>
